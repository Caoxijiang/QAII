...
<div class="act">
	...
	<div class="int-inline"><input id="ministryProperty"  type="checkbox" value="获奖单位名称" checked/><lable>获奖人员</lable></div>
...
//    height: 332,
    ...
    cols: [[ //标题栏
		...
		{field: 'contactPerson', title: '获奖人员',sort: true,width:180},
