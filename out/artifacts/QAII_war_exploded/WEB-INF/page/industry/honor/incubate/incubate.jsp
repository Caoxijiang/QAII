...
<div class="tool">
	<div class="layui-btn-group demoTable">
  	  <span class="limit">孵化企业获奖情况( <span id="countnum"> </span> )</span>
		<a href="javascript:;" onclick="srchange('incubateAdd.do')">
...
<div class="act">
	...
	<div class="int-inline"><input id="ministryProperty"  type="checkbox" value="获奖单位名称" checked/><lable>获奖企业名称</lable></div>
...
//    height: 332,
    ...
    cols: [[ //标题栏
		...
		{field: 'contactPerson', title: '获奖企业名称',sort: true,width:180},
...
//  	window.location.reload();//刷新当前页面.
  ...
  table.on('tool(demo)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
    ...
    if(layEvent === 'detail'){
    	var iframesrc="incubateCheck.do?userId='"+data.id+"'";
      ...
      layer.confirm('确定删除信息', function(index){
    	...
    	var iframesrc="incubateEdit.do?userId='"+data.id+"'";
    	$("body", parent.document).find('iframe').attr('src',iframesrc);
    }
  });
