...
<form class="layui-form" name="changePwd" method="post" action="changePwd.do" onsubmit="return isValidate(changePwd)">
    <div class="loginBox">
        ...
        <input placeholder="请输入原密码" class="admin" type="password" name="Password" />
        <div class="label"><img src="${basePath}/image/password.png" class="labelimg" /></div>
        <input placeholder="请输入新密码" class="admin" type="password" name="Confirm_Password" />
        <div class="label"><img src="${basePath}/image/code.png" class="labelimg" /></div>
        <input placeholder="确认新密码" class="admin" type="password" class="labelimg" />
