...
<div class="layui-container addtop">
	<form class="layui-form" action="insertSigningAgreement.do" method="post" enctype="multipart/form-data" lay-filter="example">
		<!-- 基本信息 -->
			...
			<div class="layui-col-xs6 layui-col-md6">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="directionCooperation" lay-verify="title" autocomplete="off" class="layui-input" disabled="">
					</div>
				</div>
			</div>
			<div class="layui-col-xs6 layui-col-md6">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="signingTime" lay-verify="title" autocomplete="off" class="layui-input" disabled="" >
					</div>
				</div>
			</div>
			<div class="layui-col-xs6 layui-col-md6">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="colleageIncubator" lay-verify="title" autocomplete="off" class="layui-input" disabled="">
					</div>
				</div>
			</div>
			<div class="layui-col-xs6 layui-col-md6">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="cooperationUnit" lay-verify="title" autocomplete="off" class="layui-input" disabled="">
					</div>
				</div>
			</div>
		</div>
		<div class="layui-row contern">
			...
			<div class="layui-col-xs12 layui-col-md12">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<textarea class="layui-textarea" name="remake" lay-verify="content" id="LAY_demo_editor" disabled=""></textarea>
					</div>
				</div>
			</div>
		</div>
                ...
                success:function(data){
                    if(data!=null){
                        ...
                        form.val('example', {
                            ...
                            /*"file1":awardInfo.listFile[0].filePath*/
                        })
                    }else{
                        alert("查看详情失败")
                    }
