...
<!-- 头部区域（可配合layui已有的水平导航） -->
    ...
    <div class="layui-side-scroll">
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
			<a class="" href="indexNav.html"><i class="layui-icon layui-icon-website" style="font-size: 22px;"></i>&nbsp;全局总览</a>
        </li>
        <li class="layui-nav-item layui-this">
          <a href="javascript:;"><i class="layui-icon layui-icon-group" style="font-size: 22px;"></i>&nbsp;权限管理</a>
        </li>
  ...
  <div class="layui-body" id="layuiBody">
	  <iframe src="RoleIframe.do" id="iframe"></iframe>
  </div>
  <!--  主要数据表格-->
