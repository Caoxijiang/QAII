...
<body>
<form action="Govrewardprocessupload.do" method="post" enctype="multipart/form-data">
  ...
  <input type="hidden" name="rewardName" id="rewardName" value="${requestScope.utflist[2]}">
