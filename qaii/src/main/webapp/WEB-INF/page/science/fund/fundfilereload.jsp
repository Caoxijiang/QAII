...
<body>
<form action="Govfundprocessupload.do" method="post" enctype="multipart/form-data">
  ...
  <input type="hidden" name="govfundName" id="govfundName" value="${requestScope.utflist[2]}">
