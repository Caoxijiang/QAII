	  ...
	  <div class="layui-row">
	    ...
	    <div class="layui-col-xs4 layui-col-md4">
	      <div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="govplatApprovalnum" class="layui-input input" id="test2" disabled="">
				</div>
			</div>
	    </div>
	    <div class="layui-col-xs4 layui-col-md4">
				...
				<div class="layui-input-block">
					<div class="layui-row">
						 <div class="layui-col-xs6 layui-col-md6">
							<input type="text" name="govplatMiddleresult" class="layui-input input" id="test4" disabled="">
						 </div>
						 <div class="layui-col-xs6 layui-col-md6">
	    ...
	    <div class="layui-col-xs4 layui-col-md4">
	      <div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div class="layui-row">
						 <div class="layui-col-xs6 layui-col-md6">
							<input type="text" name="govplatYearresult" class="layui-input input" id="test5" disabled="">
						 </div>
						 <div class="layui-col-xs6 layui-col-md6">
	    ...
	    <div class="layui-col-xs4 layui-col-md4">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div class="layui-row">
						 <div class="layui-col-xs6 layui-col-md6">
							<input type="text" name="govplatEndresult" class="layui-input input" id="test6" disabled="">
						 </div>
						 <div class="layui-col-xs6 layui-col-md6">
