...
<body>
<form action="GovPlatformprocessupload.do" method="post" enctype="multipart/form-data">
  ...
  <input type="hidden" name="govplatName" id="govplatName" value="${requestScope.utflist[2]}">
