...
<link rel="stylesheet" href="${basePath}/css/stylemain.css" />
		...
		<div class="content">
			...
			<div class="perbox col-3">
				...
				<div class="inform">
					...
					<div id="mainbar" style="width: 100%;height:470px;"></div>
					<%--<div style="height: 562px;" id="canvasBox">
						<canvas id="talents"  width="445px" height="562px"></canvas>
