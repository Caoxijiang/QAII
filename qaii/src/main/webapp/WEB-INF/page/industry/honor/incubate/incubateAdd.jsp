...
<div class="tool">
	<div class="techadd" style="width:300px;">
		...
		<span>首页&nbsp;>&nbsp;</span>
		<span class="blue">孵化企业获奖情况&nbsp;—&nbsp;添加界面</span>
	</div>
	<!--		导出-->
...
<div class="layui-container addtop">
  <form class="layui-form" action="insertAwardIncubate.do" method="post" enctype="multipart/form-data">
  <!-- 基本信息 -->
	  <div class="layui-row contern">
	  	<h1>基本信息</h1>
		<div class="layui-col-xs6 layui-col-md6">
			 <div class="layui-form-item">
			    <label class="layui-form-label">获奖企业名称&nbsp;<span class="star">*</span></label>
			    <div class="layui-input-block">
			      <input type="text" name="awardUnit" lay-verify="required" autocomplete="off" class="layui-input">
			    </div>
			  </div>
		</div>
	    <div class="layui-col-xs6 layui-col-md6">
