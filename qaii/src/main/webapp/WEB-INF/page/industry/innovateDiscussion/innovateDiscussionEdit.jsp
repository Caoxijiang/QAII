...
<div class="tool">
	<div class="techadd" style="width:330px;">
		...
		<span>首页&nbsp;>&nbsp;</span>
		<span class="blue">交流座谈情况&nbsp;—&nbsp;修改界面</span>
	</div>
	<!--导出-->
...
<div class="layui-container addtop">
	<form class="layui-form" action="updateExchangeTalks.do" method="post" enctype="multipart/form-data" lay-filter="example">
		<!-- 基本信息 -->
                ...
                success:function(data){
                    if(data!=null){
                        ...
                        form.val('example', {
                            ...
                            "fid":awardInfo.listFile[0].id,//附件id
...
<script type="text/javascript">
    ...
    $("#upload").click(function(){
        ...
        layer.open({
            type:2,
            title:"重新上传文件",
            content:'innovateDiscussionfilereload.do?id='+id+'&fid='+fid+'&fpath='+fpath,
            anim:0
        });
    })
